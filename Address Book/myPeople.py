...
class MyPeople(Toplevel):
    def __init__(self):
        ...
        btnaDisplay = Button(self.bottomFrame, text="Display", width=12, font='Sans 12 bold', command=self.funcDisplayPerson)
    ...
    def funcDeletePerson(self):
        ...
        if mbox == 'yes':
            try:
                ...
                messagebox.showinfo("Error", "Cant Delete this person, try again", icon='warning')
...
class Update(Toplevel):
    def __init__(self):
        ...
        self.top_image_lbl = Label(self.top, image=self.top_image, bg='white')
        self.top_image_lbl.place(x=120, y=10)
        self.heading = Label(self.top, text="My Person", font="arial 15 bold", fg='#003f8a', bg='white')
        self.heading.place(x=260, y=60)
